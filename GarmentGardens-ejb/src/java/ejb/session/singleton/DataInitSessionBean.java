...
public class DataInitSessionBean {
    ...
    private void initaliseCategoriesTags() throws UnknownPersistenceException, ProductSkuCodeExistException, CreateNewTagException, CreateNewProductException, CreateNewCategoryException, InputDataValidationException, UserNotFoundException, UserUsernameExistException {
        ...
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD001", "Navy Blue T shirt", "The T-shirt is made from 100% recyclable cotton", 100, new BigDecimal("10.00"), true, "https://i.imgur.com/xkV92KB.jpg"), tShirts.getCategoryId(), tagIdsPopular, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD002", "Prada T shirt", "The T-shirt is made from 100% recyclable cotton", 100, new BigDecimal("25.50"), true, "https://i.imgur.com/HR9tEFl.jpg"), tShirts.getCategoryId(), tagIdsDiscount, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD003", "Nasi T shirt", "The T-shirt is made from 100% recyclable cotton", 100, new BigDecimal("15.00"), true, "https://i.imgur.com/GuNrG8y.jpg"), tShirts.getCategoryId(), tagIdsPopularDiscount, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD004", "Highs Nobiety Hoodie Grey", "The hoodie is created in a sustainable fashion with minimal damage to the environment", 100, new BigDecimal("20.00"), true, "https://i.imgur.com/w6A6tJn.png"), hoodies.getCategoryId(), tagIdsPopularNew, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD005", "Razer Sneki Snack Hoodie", "The hoodie is 2nd hand but it is as good as new", 100, new BigDecimal("10.00"), true, "https://i.imgur.com/o4WWrLZ.png"), hoodies.getCategoryId(), tagIdsPopularDiscountNew, seller1));
        ...
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD007", "Dior Oblique Black Jacket", "This jacket is made of 100% recyclable materials", 100, new BigDecimal("35.00"), true, "https://i.imgur.com/k9jo5IO.png"), jackets.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD008", "H&M Bomber Racer Jacket", "Suitable for cold weather and temperate climate, 100% recyclable wool", 100, new BigDecimal("20.05"), true, "https://i.imgur.com/d0ZHfWE.png"), jackets.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD009", "FairPrice Winter Jacket", "This jacket is 2nd hand but it looks as good as new", 100, new BigDecimal("5.50"), true, "https://i.imgur.com/zggE7a2.jpg"), jackets.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD010", "Uniqlo Airism Cotton Tanktop", "Made from 100% sustainable cotton", 100, new BigDecimal("20.50"), true, "https://i.imgur.com/hKAPzWV.png"), singlets.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD011", "H&M Women's Tank Top", "Made from 100% sustainable cotton", 100, new BigDecimal("30.50"), true, "https://i.imgur.com/dUZfqK0.png"), singlets.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD012", "Uniqlo Airism Men's Singlet", "Made from 100% sustainable cotton", 100, new BigDecimal("18.50"), true, "https://i.imgur.com/5CZkFXd.png"), singlets.getCategoryId(), tagIdsEmpty, seller1));
        ...
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD017", "H&M Men's Cargo Pants", "Made from 100% sustainable cotton", 100, new BigDecimal("19.05"), true, "https://i.imgur.com/BXvojti.png"), cargopants.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD018", "Giordano Cargo Pants", "Made from 100% sustainable cotton", 100, new BigDecimal("10.50"), true, "https://i.imgur.com/2kI6fCQ.png"), cargopants.getCategoryId(), tagIdsEmpty, seller1));
        ...
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD020", "Les Tien Women's Sweat Pants", "Made from 100% sustainable cotton", 100, new BigDecimal("19.05"), true, "https://i.imgur.com/AQ6MeRb.png"), sweatpants.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD021", "Sarah Jessica Sweat Pants", "Made from 100% sustainable cotton", 100, new BigDecimal("10.50"), true, "https://i.imgur.com/9nXz6RY.png"), sweatpants.getCategoryId(), tagIdsEmpty, seller1));
        ...
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD023", "Nike Cap", "Made from 100% sustainable cotton", 100, new BigDecimal("19.05"), true, "https://i.imgur.com/8dRmKTR.png"), hats.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD024", "Timberland Cap", "Made from 100% sustainable cotton", 100, new BigDecimal("10.50"), true, "https://i.imgur.com/USPPVOm.png"), hats.getCategoryId(), tagIdsEmpty, seller1));
        ...
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD026", "Reebok Men's Boxer", "Made from 100% sustainable cotton", 100, new BigDecimal("19.05"), true, "https://i.imgur.com/sd1HgsQ.png"), boxers.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD027", "Supreme Men's Boxer", "Made from 100% sustainable cotton", 100, new BigDecimal("10.50"), true, "https://i.imgur.com/rTPWJI8.png"), boxers.getCategoryId(), tagIdsEmpty, seller1));
        list.add(productEntitySessionBeanLocal.createNewProductFrontEnd(new ProductEntity("PROD028", "Puma Men's Boxer", "Made from 100% sustainable cotton", 100, new BigDecimal("17.50"), true, "https://i.imgur.com/29OP8i5.png"), boxers.getCategoryId(), tagIdsEmpty, seller1));
