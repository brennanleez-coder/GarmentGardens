...
public class CreateCreditCardReq {
    ...
    public CreateCreditCardReq(String username, String password, String holderName, String creditCardNumber, String cvv, Date expiryDate, String billinagAddress, UserEntity user, AdvertiserEntity advertiser) {
